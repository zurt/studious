...
- [x] Native macOS app (see `docs/mac-app-plan.md`; shipped 2026-07-05):
      ...
      (`make run-mac`). Still open: signed .app bundle + in-app
      CloudKit once an Xcode machine is available (replaces the
      `studious-sync sync` CLI)
